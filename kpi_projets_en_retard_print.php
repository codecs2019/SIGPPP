...
require_once("include/kpi_projets_en_retard_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_projets_en_retard" );
