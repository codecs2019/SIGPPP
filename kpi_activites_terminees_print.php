...
require_once("include/kpi_activites_terminees_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_activites_terminees" );
