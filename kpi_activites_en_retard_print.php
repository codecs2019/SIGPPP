...
require_once("include/kpi_activites_en_retard_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_activites_en_retard" );
