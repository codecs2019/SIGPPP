...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sigpppportefeuilleatlocalhost";
		$data["connName"] = "sigppp_portefeuille at localho";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;sigppp_portefeuille;http://localhost/appgpp/phprunner.php;0"; //currently unused

		$this->_connectionsIdByName["sigppp_portefeuille at localho"] = "sigpppportefeuilleatlocalhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "sigppp_portefeuille";
		$data["connInfo"][5] = "http://localhost/appgpp/phprunner.php"; //currently unused
		$data["connInfo"][6] = "0"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=sigppp_portefeuille;OPTION=3";
		// encription set
		...
		$connectionsData["sigpppportefeuilleatlocalhost"] = $data;
