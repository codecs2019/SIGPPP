...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "sigpppportefeuilleatlocalhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "activite", "varname" => "sigpppportefeuilleatlocalhost__activite", "altvarname" => "activite", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "archivage", "varname" => "sigpppportefeuilleatlocalhost__archivage", "altvarname" => "archivage", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "budget", "varname" => "sigpppportefeuilleatlocalhost__budget", "altvarname" => "budget", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "depense", "varname" => "sigpppportefeuilleatlocalhost__depense", "altvarname" => "depense", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "document_projet", "varname" => "sigpppportefeuilleatlocalhost__document_projet", "altvarname" => "document_projet", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "indicateur", "varname" => "sigpppportefeuilleatlocalhost__indicateur", "altvarname" => "indicateur", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "portefeuille", "varname" => "sigpppportefeuilleatlocalhost__portefeuille", "altvarname" => "portefeuille", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "programme", "varname" => "sigpppportefeuilleatlocalhost__programme", "altvarname" => "programme", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "projet", "varname" => "sigpppportefeuilleatlocalhost__projet", "altvarname" => "projet", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "raci", "varname" => "sigpppportefeuilleatlocalhost__raci", "altvarname" => "raci", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "valeur_indicateur", "varname" => "sigpppportefeuilleatlocalhost__valeur_indicateur", "altvarname" => "valeur_indicateur", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_avancement_global", "varname" => "sigpppportefeuilleatlocalhost__vue_avancement_global", "altvarname" => "vue_avancement_global", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_kpi_portefeuille", "varname" => "sigpppportefeuilleatlocalhost__vue_kpi_portefeuille", "altvarname" => "vue_kpi_portefeuille", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_performance_projets", "varname" => "sigpppportefeuilleatlocalhost__vue_performance_projets", "altvarname" => "vue_performance_projets", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_projets_derive", "varname" => "sigpppportefeuilleatlocalhost__vue_projets_derive", "altvarname" => "vue_projets_derive", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_repartition_projets", "varname" => "sigpppportefeuilleatlocalhost__vue_repartition_projets", "altvarname" => "vue_repartition_projets", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
			$dalTables[$conn->connId][] = array("name" => "vue_suivi_budgetaire", "varname" => "sigpppportefeuilleatlocalhost__vue_suivi_budgetaire", "altvarname" => "vue_suivi_budgetaire", "connId" => "sigpppportefeuilleatlocalhost", "schema" => "", "connName" => "sigppp_portefeuille at localho");
		}
	}
