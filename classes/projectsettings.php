...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Projets" ] = array( "url" => "projets", "type" => 1 );
	$projectEntitiesReverse[ "projets" ] = "Projets";
	$projectEntities[ "vue_avancement_global" ] = array( "url" => "vue_avancement_global", "type" => 0 );
	$projectEntitiesReverse[ "vue_avancement_global" ] = "vue_avancement_global";
	$projectEntities[ "vue_performance_projets" ] = array( "url" => "vue_performance_projets", "type" => 0 );
	$projectEntitiesReverse[ "vue_performance_projets" ] = "vue_performance_projets";
	$projectEntities[ "vue_projets_derive" ] = array( "url" => "vue_projets_derive", "type" => 0 );
	$projectEntitiesReverse[ "vue_projets_derive" ] = "vue_projets_derive";
	$projectEntities[ "vue_repartition_projets" ] = array( "url" => "vue_repartition_projets", "type" => 0 );
	$projectEntitiesReverse[ "vue_repartition_projets" ] = "vue_repartition_projets";
	$projectEntities[ "vue_suivi_budgetaire" ] = array( "url" => "vue_suivi_budgetaire", "type" => 0 );
	$projectEntitiesReverse[ "vue_suivi_budgetaire" ] = "vue_suivi_budgetaire";
	$projectEntities[ "Activites" ] = array( "url" => "activites", "type" => 1 );
	$projectEntitiesReverse[ "activites" ] = "Activites";
	$projectEntities[ "Archivages" ] = array( "url" => "archivages", "type" => 1 );
	$projectEntitiesReverse[ "archivages" ] = "Archivages";
	$projectEntities[ "Budgets" ] = array( "url" => "budgets", "type" => 1 );
	$projectEntitiesReverse[ "budgets" ] = "Budgets";
	$projectEntities[ "Depenses" ] = array( "url" => "depenses", "type" => 1 );
	$projectEntitiesReverse[ "depenses" ] = "Depenses";
	$projectEntities[ "Documents_projets" ] = array( "url" => "documents_projets", "type" => 1 );
	$projectEntitiesReverse[ "documents_projets" ] = "Documents_projets";
	$projectEntities[ "Indicateurs" ] = array( "url" => "indicateurs", "type" => 1 );
	$projectEntitiesReverse[ "indicateurs" ] = "Indicateurs";
	$projectEntities[ "Portefeuille" ] = array( "url" => "portefeuille", "type" => 1 );
	$projectEntitiesReverse[ "portefeuille" ] = "Portefeuille";
	$projectEntities[ "Programmes" ] = array( "url" => "programmes", "type" => 1 );
	$projectEntitiesReverse[ "programmes" ] = "Programmes";
	$projectEntities[ "Raci" ] = array( "url" => "raci", "type" => 1 );
	$projectEntitiesReverse[ "raci" ] = "Raci";
	$projectEntities[ "Valeurs_indicateurs" ] = array( "url" => "valeurs_indicateurs", "type" => 1 );
	$projectEntitiesReverse[ "valeurs_indicateurs" ] = "Valeurs_indicateurs";
	$projectEntities[ "Tableau_De_Bord" ] = array( "url" => "tableau_de_bord", "type" => 4 );
	$projectEntitiesReverse[ "tableau_de_bord" ] = "Tableau_De_Bord";
	$projectEntities[ "kpi_ProjetsEnCours" ] = array( "url" => "kpi_projetsencours", "type" => 1 );
	$projectEntitiesReverse[ "kpi_projetsencours" ] = "kpi_ProjetsEnCours";
	$projectEntities[ "kpi_ActivitesEnCours" ] = array( "url" => "kpi_activitesencours", "type" => 1 );
	$projectEntitiesReverse[ "kpi_activitesencours" ] = "kpi_ActivitesEnCours";
	$projectEntities[ "kpi_BudgetGlobal" ] = array( "url" => "kpi_budgetglobal", "type" => 1 );
	$projectEntitiesReverse[ "kpi_budgetglobal" ] = "kpi_BudgetGlobal";
	$projectEntities[ "vue_kpi_portefeuille" ] = array( "url" => "vue_kpi_portefeuille", "type" => 0 );
	$projectEntitiesReverse[ "vue_kpi_portefeuille" ] = "vue_kpi_portefeuille";
	$projectEntities[ "kpi_projets_termines" ] = array( "url" => "kpi_projets_termines", "type" => 1 );
	$projectEntitiesReverse[ "kpi_projets_termines" ] = "kpi_projets_termines";
	$projectEntities[ "kpi_activites_terminees" ] = array( "url" => "kpi_activites_terminees", "type" => 1 );
	$projectEntitiesReverse[ "kpi_activites_terminees" ] = "kpi_activites_terminees";
	$projectEntities[ "kpi_projets_depassement_budget" ] = array( "url" => "kpi_projets_depassement_budget", "type" => 1 );
	$projectEntitiesReverse[ "kpi_projets_depassement_budget" ] = "kpi_projets_depassement_budget";
	$projectEntities[ "kpi_projets_en_retard" ] = array( "url" => "kpi_projets_en_retard", "type" => 1 );
	$projectEntitiesReverse[ "kpi_projets_en_retard" ] = "kpi_projets_en_retard";
	$projectEntities[ "kpi_activites_en_retard" ] = array( "url" => "kpi_activites_en_retard", "type" => 1 );
	$projectEntitiesReverse[ "kpi_activites_en_retard" ] = "kpi_activites_en_retard";
	$projectEntities[ "kpi_depenses_realisees" ] = array( "url" => "kpi_depenses_realisees", "type" => 1 );
	$projectEntitiesReverse[ "kpi_depenses_realisees" ] = "kpi_depenses_realisees";
	$projectEntities[ "kpi_budget_restant" ] = array( "url" => "kpi_budget_restant", "type" => 1 );
	$projectEntitiesReverse[ "kpi_budget_restant" ] = "kpi_budget_restant";
	$projectEntities[ "kpi_taux_execution_budgetaire" ] = array( "url" => "kpi_taux_execution_budgetaire", "type" => 1 );
	$projectEntitiesReverse[ "kpi_taux_execution_budgetaire" ] = "kpi_taux_execution_budgetaire";
}
