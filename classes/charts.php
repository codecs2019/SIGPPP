...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("projet" == $this->chrt_array['tables'][0])
			return true;
		if("vue_avancement_global" == $this->chrt_array['tables'][0])
			return true;
		if("vue_performance_projets" == $this->chrt_array['tables'][0])
			return true;
		if("vue_projets_derive" == $this->chrt_array['tables'][0])
			return true;
		if("vue_repartition_projets" == $this->chrt_array['tables'][0])
			return true;
		if("vue_suivi_budgetaire" == $this->chrt_array['tables'][0])
			return true;
		if("activite" == $this->chrt_array['tables'][0])
			return true;
		if("archivage" == $this->chrt_array['tables'][0])
			return true;
		if("budget" == $this->chrt_array['tables'][0])
			return true;
		if("depense" == $this->chrt_array['tables'][0])
			return true;
		if("document_projet" == $this->chrt_array['tables'][0])
			return true;
		if("indicateur" == $this->chrt_array['tables'][0])
			return true;
		if("portefeuille" == $this->chrt_array['tables'][0])
			return true;
		if("programme" == $this->chrt_array['tables'][0])
			return true;
		if("raci" == $this->chrt_array['tables'][0])
			return true;
		if("valeur_indicateur" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("vue_kpi_portefeuille" == $this->chrt_array['tables'][0])
			return true;
		if("vue_kpi_portefeuille" == $this->chrt_array['tables'][0])
			return true;
		if("vue_kpi_portefeuille" == $this->chrt_array['tables'][0])
