...
require_once("include/kpi_depenses_realisees_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_depenses_realisees" );
