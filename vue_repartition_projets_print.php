...
require_once("include/vue_repartition_projets_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "vue_repartition_projets" );
