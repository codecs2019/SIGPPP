...
class oLocking
{
	...
	function __construct()
	{
		...
		$this->ConfirmAdmin = "L'administrateur a terminé votre session editer";
		$this->ConfirmUser = "Votre session est expirée";
		$this->LockAdmin = "L'enregistement est édité par %s pendant %s minutes";
		$this->LockUser = "L'enregistement est édité par un autre utilisateur";
		...
		{			
			...
			if( $links ) {
				$str.='<a class="unlock" href="#">'
					."Débloquer l'enregistrement".'</a>';
				$str.='<a class="edit" href="#">'
					."Editer enregistrement".'</a>';
			}
