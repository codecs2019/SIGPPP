...
require_once("include/kpi_activitesencours_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_ActivitesEnCours" );
