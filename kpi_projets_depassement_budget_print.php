...
require_once("include/kpi_projets_depassement_budget_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "kpi_projets_depassement_budget" );
