...
require_once("include/valeurs_indicateurs_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Valeurs_indicateurs" );
